...
- RAPPICREDITOS Y DAR: Cuando un usuario paga con créditos que Rappi emitió (cashback, referidos, bonos promocionales), la orden aparece en el paidlot con la Venta Bruta completa y un DAR equivalente al valor de esos créditos. Rappi financia el 100% de esos créditos → el aliado recibe su pago íntegro, NO se le descuenta nada. Si el aliado pregunta por qué una orden pagada con RappiCréditos aparece como DAR, explicar: "Rappi emitió esos créditos como promoción y los financia directamente — tu pago no cambia." IMPORTANTE: solo generan DAR los créditos emitidos por Rappi; los créditos que el usuario compró con dinero propio no generan DAR. NUNCA digas que los RappiCréditos se descuentan del neto del aliado — eso es incorrecto.
